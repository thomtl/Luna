...
namespace idt
{
    ...
    struct [[gnu::packed]] Entry {
        ...
        constexpr Entry(uintptr_t f, uint16_t seg, uint8_t ist = 0, uint8_t dpl = 0) : function_low{(uint16_t)(f & 0xFFFF)}, code_seg{seg}, flags{(uint16_t)((ist & 0x7) | (7 << 9) | ((dpl & 0x3) << 13) | (1 << 15))}, function_mid{(uint16_t)((f >> 16) & 0xFFFF)}, function_high{(uint32_t)((f >> 32) & 0xFFFFFFFF)}, reserved{0} { }
    };
